...
#--------- Main Routine ---------
rounds = 1
infinite_mode = yes_no("Would you like to play infinte mode?","Infinite mode set to ESC[38:5:219mTrueESC[38:5:0m","Infinte mode set to false","That is a invalid answer.\nValid answers are Yes or No")
print("\n--------------------\n")
